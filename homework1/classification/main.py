# Copyright 2022 Xia Chen-rui
# Contact: xiachenrui@mail.cbi.pku.edu.cn

r''' 
This file is main entrance of the whole project.
...
# callbacks in pytorch_lightning means the code which it not directly related to the model
def load_callbacks():
    callbacks = []
...
def main(args):
    ...
    # # If you want to change the logger's saving folder, because pl default use tensorboard and save in `lightning_logs/`
